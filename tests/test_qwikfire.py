...
class AnnotatedTestClass:
    ...
    def single_manyvars(self, qf: QwikFire) -> str:
        result = qf.run(self, fee="I smell the blood of ", fii=5, foe="Englishmen,", fum="yummy!")
...
def test_single_manyvars():
    assert AnnotatedTestClass().single_manyvars() == "I smell the blood of 5 Englishmen, yummy!"
